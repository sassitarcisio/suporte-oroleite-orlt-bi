  ...
  return <section className="closing-statement payroll-statement" aria-label="Fechamento para folha de pagamento">
    ...
    {ready && summary && <>
      <section className="statement-totals payroll-totals" aria-label="Resumo da folha">
        <article><h2><i className="card-label-icon fa-solid fa-user-tie" aria-hidden="true" /> Vendedores</h2><strong>{summary.sellerCount}</strong><p>Participantes da folha</p></article>
        <article><h2><i className="card-label-icon fa-solid fa-sack-dollar" aria-hidden="true" /> Faturamento / base</h2><strong className="statement-text-value">Não consolidar</strong><p>As bases podem se sobrepor</p></article>
        <article><h2><i className="card-label-icon fa-solid fa-calculator" aria-hidden="true" /> Comissões</h2><strong>{money(summary.totalCommission)}</strong><p>Total do período</p></article>
        <article><h2><i className="card-label-icon fa-solid fa-trophy" aria-hidden="true" /> Incentivos</h2><strong>{money(summary.totalIncentives)}</strong><p>PPP, metas e troca</p></article>
        <article className="statement-total"><h2><i className="card-label-icon fa-solid fa-money-check-dollar" aria-hidden="true" /> Total da folha</h2><strong>{money(summary.total)}</strong><p>Salários + comissões + incentivos</p></article>
      </section>
      <section className="statement-table-panel"><h2><i className="card-label-icon fa-solid fa-user-tie" aria-hidden="true" /> Demonstrativo por vendedor</h2><div className="statement-table-scroll"><table className="payroll-table" aria-label="Fechamento para folha de pagamento">
      ...
      <section className="statement-rules" aria-label="Critérios da folha de pagamento">
        <article><h2><i className="card-label-icon fa-solid fa-sack-dollar" aria-hidden="true" /> Base de faturamento</h2><p>O faturamento é informado por vendedor e não é somado: supervisão, cobertura de férias e fechamento geral podem compartilhar vendas.</p></article>
        <article><h2><i className="card-label-icon fa-solid fa-umbrella-beach" aria-hidden="true" /> Cobertura de férias</h2><p>Tiago utiliza o faturamento, a comissão e os prêmios de {summary.coverageSeller}. O salário-base é o salário padrão da folha.</p></article>
        <article><h2><i className="card-label-icon fa-solid fa-trophy" aria-hidden="true" /> Prêmio da supervisão</h2><p>Na folha, a média de Deivid considera os prêmios calculados dos sete vendedores, incluindo Paulo. No demonstrativo da supervisão, Paulo participa das vendas e do divisor, mas seu prêmio exibido é zero por não integrar as linhas da folha.</p></article>
      </section>
